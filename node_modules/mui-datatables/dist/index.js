...
function _objectWithoutProperties(e, t) {
    ...
    if (Object.getOwnPropertySymbols)
        for (var n = Object.getOwnPropertySymbols(e), r = 0; r < n.length; r++) a = n[r], 0 <= t.indexOf(a) || Object.prototype.propertyIsEnumerable.call(e, a) && (o[a] = e[a]);
    return o
}
            ...
            return _defineProperty(_assertThisInitialized(s = o.call.apply(o, [this].concat(t))), "handleRowSelect", function (a, e) {
                ...
                if (t && n && n.index < s.props.data.length) {
                    ...
                    for (; r !== a.index;) ! function () {
                        var e, t = s.props.data[r].dataIndex;
...
var useStyles$4 = styles.makeStyles(function () {
    ...
    handleHover = function (e) {
        ...
        if (o === t.getItem().headCellRefs && u !== a) {
            for (var f = reorderColumns(r, t.getItem().colIndex, a), h = getColModel(o, f, p), m = t.getClientOffset().x, b = -1, y = 0; y < h.length; y++)
                if (m > h[y].left && m < h[y].left + h[y].width) {
                    b = h[y].columnIndex;
                    break
    ...
    TableHead = function (e) {
        ...
        var C = _slicedToArray(React.useState(!1), 2),
            ...
            k = 0 < I && I < l,
            D = 0 < I && l <= I;
        if (!0 === p.disableToolbarSelect || "none" === p.selectToolbarPlacement || "above" === p.selectToolbarPlacement)
            if (D) {
                for (var E = 0; E < s.length; E++)
                    if (!u.lookup[s[E].dataIndex]) {
                        k = !(D = !1);
                        break
                    }
            } else l < I && (k = !0);
...
var TableResize = function () {
        ...
        function n() {
            ...
            return _defineProperty(_assertThisInitialized(S = o.call.apply(o, [this].concat(t))), "state", {
                ...
                var a, o, i, l, s, c, d, p, u, f = S.state,
                    h = f.isResize,
                    m = f.resizeCoords,
                    b = f.lastColumn,
                    y = S.minWidths[e],
    ...
    TableToolbar = function () {
        ...
        function n() {
            ...
            return _defineProperty(_assertThisInitialized(d = o.call.apply(o, [this].concat(t))), "state", {
                ...
                var a, o, n, r = d.state.iconActive === t;
    ...
    getTextLabels = function () {
        return {
            body: {
                noMatch: "Aguarde, carregando dados",
                toolTip: "Ordenar"
            },
            pagination: {
                next: "Próxima página",
    ...
    TOOLBAR_ITEMS = ["title", "filter", "Pesquisa", "print", "download", "viewColumns", "customToolbar"],
    ...
    MUIDataTable = function () {
            ...
            _classCallCheck(this, a), _defineProperty(_assertThisInitialized(u = t.call(this, e)), "getDefaultOptions", function () {
                ...
                if (0 < e.length)
                    for (var o = e.length - 1; 0 <= o; o--) {
                        ...
                        for (var r = 0; r < u.state.data.length; r++) {
                            var i, l = u.state.data[r];
                ...
                for (var t = e.dataIndex, a = u.options.isRowExpandable, o = u.state.expandedRows, n = _toConsumableArray(o.data), r = !1, i = !1, l = [], s = 0; s < n.length; s++)
                    if (n[s].dataIndex === t) {
                        r = !0;
                        break
                ...
                var c, t, a, o, d = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : [],
                ...
                "none" !== p && ("head" === e ? (c = u.options.isRowSelectable, u.setState(function (e) {
                    var o = e.displayData,
                        ...
                        i = buildMap(r);
                    if (u.options.selectToolbarPlacement === STP.NONE)
                        if (t > o.length) a = !0;
                        else
                            for (var l = 0; l < o.length; l++) i[o[l].dataIndex] || (a = !0);
                    ...
                    for (var t, a = s.dataIndex, o = _toConsumableArray(e.selectedRows.data), n = -1, r = 0; r < o.length; r++)
                        if (o[r].dataIndex === a) {
                            n = r;
                            break
                        } if (0 <= n) {
                        if (o.splice(n, 1), 0 < d.length)
                            for (var i = buildMap(d), l = o.length - 1; 0 <= l; l--) i[o[l].dataIndex] && o.splice(l, 1)
        ...
        return _createClass(a, [{
            ...
            value: function (e, l, t, a, o) {
                ...
                "number" == typeof this.options.page && (v = this.options.page), u.forEach(function (e, a) {
                    for (var t, o = 0; o < _.length; o++) {
                        var n, r, i = l === TABLE_LOAD.INITIAL ? _[o][a] : _[o].data[a];
                        void 0 === p[o] && p.push({
                ...
                if (this.options.rowsSelected && this.options.rowsSelected.length && "multiple" === this.options.selectableRows) this.options.rowsSelected.filter(function (e) {
                    ...
                    for (var t = e, a = 0; a < d.state.displayData.length; a++)
                        if (d.state.displayData[a].dataIndex === e) {
                            t = a;
                            break
                        } R.data.push({
                        index: t,
                    ...
                    for (var T = this.options.rowsSelected[0], C = 0; C < this.state.displayData.length; C++)
                        if (this.state.displayData[C].dataIndex === this.options.rowsSelected[0]) {
                            T = C;
                            break
                        } R.data.push({
                        index: T,
            ...
            value: function (d, p, u, f, h, m, b, e, y) {
                ...
                var a, o = e.options.customSearch;
